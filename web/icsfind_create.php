        ...
        function task_create(){
            ...
            $.ajax({
                ...
                success: function(msg){
                    if (msg == true) {alert('ICS scan Success');}
                    else {alert('ICS scans Faild');}
                    location.href = 'icsfind.php';
                }
            });
        }
            ...
            <div class="panel-body collapse in" id="options">
                <div class="content" style="overflow: hidden; display: block;">
                    ...
                    <div class="row form-line">
                        ...
                        <div class="col-md-10">
                            <input type="radio" name="config[global][choose]" value="modbus"> Modbus : 502<br>
                            <input type="radio" name="config[global][choose]" value="semens"> Semens S7 : 102
                        </div>
                    </div>
                </div>
            </div>
